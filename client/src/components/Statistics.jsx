    ...
    >
      <div class="gap-2 text-lg flex flex-col lg:flex-row justify-between items-center my-3 ">
        <div className="flex flex-col  items-center">
          <h3 class="text-5xl font-semibold text-center">Current Statistics</h3>
        ...
        <div className="flex gap-2 w-full max-w-[1000px]">
          <Card className="text-xl flex flex-col bg-gray-600 p-5 justify-between">
            <div class="h-10  h-full my-2 flex gap-3 justify-center items-center  bg-gray-700 rounded-full">
              <p>Longest Streak</p>
              <CountUp
                end={streak}
                duration={5}
            ...
            <div class="h-full my-2 flex  justify-center gap-3 items-center  bg-gray-700 rounded-full">
              <p>Most single day</p>
              <CountUp
                end={max}
                duration={5}
